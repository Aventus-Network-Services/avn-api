...
AvnApi.prototype.init = async function () {
  ...
  const setupSigner = async () => {
    ...
    if (hasRemoteSigner === true) {
      const updateSignFunction = (signer) => {
        this.options.signer = {
            ...
            publicKey: Utils.convertToPublicKeyBytes(this.options.signer.address)
        };
      }

      updateSignFunction(this.options.signer);

      console.log("post signer setup: ", this.options.signer)
    }
