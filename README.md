...
## Prerequisites
To access the AvN gateway you must initially hold a minimum 1 AVT in your AvN account.\
Accounts can be generated by the API, passed via options, or by directly setting "AVN_SURI" environment variable.\
Either the account seed (private key) or mnemonic may be used. eg:\
`export AVN_SURI="history mule trend shove lawsuit spray fall tongue patient social ribbon tooth"` \
`export AVN_SURI=0x816ef9f2c7f9e8c013fd5fca220a1bf23ff2f3b268f8bcd94d4b5df96534173f`
_**Note:** Keep your mnemonic/seed safe and private. If compromised you could lose all your account's funds._
