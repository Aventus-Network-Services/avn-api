...
## Gateway access
Any account wanting to access the AvN gateway must initially hold a minimum 1 AVT.

## Accounts
Accounts can be generated by the API utility.\
An account can be assigned by any of the following:
...
`set AVN_SURI=0x816ef9f2c7f9e8c013fd5fca220a1bf23ff2f3b268f8bcd94d4b5df96534173f`
