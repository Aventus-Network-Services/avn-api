...
Accounts can be generated by the API, passed via options, or by directly setting the "AVN_SURI" environment variable.\
Either the account seed or mnemonic may be used, eg:\
