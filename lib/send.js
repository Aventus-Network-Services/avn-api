...
function transferAvt(api, queryApi, signer) {
  return async function (recipient, amount) {
    ...
    console.log(" - pre avt contract")
    const token = await queryApi.getAvtContractAddress();
    console.log(" - post avt contract")
