...
class ProxyNonceCache {
    ...
    async #waitForLockAndGetNonce(signerAddress, nonceType) {
        ...
        console.log(`Timeout expired waiting for nonce to be unlocked, forcing to unlock. Signer: ${signerAddress}, nonceType: ${nonceType}.`)
        await this.cacheProvider.unlockNonce(signerAddress, nonceType)
        return await this.cacheProvider.getNonce(signerAddress, nonceType);
    }
}
