class InMemoryNonceCacheProvider {
    ...
    async getNonce(signerAddress, nonceType) {
        ...
        console.log("\n[getNonce]: ", this.nonceMap[signerAddress][nonceType])
    ...
    async getNonceAndLock(signerAddress, nonceType) {
        ...
        if (nonceData.locked === false) {
            ...
            console.log("\n[getNonceAndLock]: ", { lockAquired: true, data: nonceData })
            return { lockAquired: true, data: nonceData };
        }

        console.log("\n[getNonceAndLock]: ", { lockAquired: false, data: {} })
    ...
    async incrementNonce(signerAddress, nonceType, updateLastUpdate) {
        ...
        console.log("\n[incrementNonce]: ", this.nonceMap[signerAddress][nonceType])
        return this.nonceMap[signerAddress][nonceType];
    }
    ...
    async setNonce(signerAddress, nonceType, nonce) {
        console.log("setNonce called for ", signerAddress, nonceType)
        ...
        console.log("\n[setNonce]: ", this.nonceMap[signerAddress][nonceType])
    }
}
